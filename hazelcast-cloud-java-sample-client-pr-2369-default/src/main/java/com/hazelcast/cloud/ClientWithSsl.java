...
public class ClientWithSsl {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.setProperty("javax.net.ssl.keyStorePassword", "024ac82e531");
        props.setProperty("javax.net.ssl.trustStore", classLoader.getResource("client.truststore").toURI().getPath());
        props.setProperty("javax.net.ssl.trustStorePassword", "024ac82e531");
        ClientConfig config = new ClientConfig();
        config.getNetworkConfig().setSSLConfig(new SSLConfig().setEnabled(true).setProperties(props));
        config.setProperty(STATISTICS_ENABLED.getName(), "true");
        config.setProperty(HAZELCAST_CLOUD_DISCOVERY_TOKEN.getName(), "A0laIELrdPl4EZTIt5xdSz4BARwz3QpHZBD1hXxdKhXS2GK0rt");
        config.setClusterName("pr-2369");
